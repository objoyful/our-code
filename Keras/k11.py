...
tensorboard = TensorBoard(log_dir=os.path.join('Keras', 'k11-data', 'logs', NAME))

# filepath = "RNN_Final-{epoch:02d}-{val_acc:.3f}"
# checkpoint = ModelCheckpoint(os.path.join("models", "{}.model".format(filepath, monitor='val_acc', verbose=1, save_best_only=True, mode='max')))

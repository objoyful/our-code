...
// middle initial, and last order
{
  ...
  TextDialog firstNameDialog("Enter the patient's first name: ");
  TextDialog lastNameDialog("Enter the patient's last name: ");
  TextDialog middleInitialDialog("Enter the patient's middle initial: ");
  firstName = firstNameDialog.display();
  lastName = lastNameDialog.display();
  middleInitial = middleInitialDialog.display();
...
// values on file healthProfile.
{
  ...
  IntDialog hdlDialog("Enter HDL for " + name + ":");
  IntDialog ldlDialog("Enter LDL for " + name + ":");
  HDL = hdlDialog.display();
  LDL = ldlDialog.display();
  float ratio = HDL / LDL;
...
// calculates the body mass index. Input in English weights.
{
  ...
  // NEW
  IntDialog weightDialog("Enter the weight in pounds for " + name + ": ");
  IntDialog heightDialog("Enter the height in inches for " + name + ": ");
  pounds = weightDialog.display();
  inches = heightDialog.display();
  // NEW
...
// on file healthProfile.
{
  ...
  // NEW
  IntDialog systolicDialog("Enter the systolic blood pressure reading for " +
                           name + ": ");
  IntDialog diastolicDialog("Enter the diastolic blood pressure reading for " +
                            name + ": ");
  systolic = systolicDialog.display();
  diastolic = diastolicDialog.display();
  // NEW

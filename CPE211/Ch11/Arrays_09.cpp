// Arrays Program 09:  Arrays_09.cpp
#include <iostream>
#include <iomanip> // for setw
using namespace std;

// Examples of two dimensional arrays with functions 
// This example is an expansion of Arrays_08.cpp
...
const int ROWS = 7;  // number of rows in the array
...
void PrintArrays(const IntArray, const int[][COLS]); // prototype with a typedef and without a typedef
...
int main() {
    ...
    // check other dimensions to see if they work.
    // first dimension size does not matter, 2nd and higher must be the same as the parameter
	// int grid2[ROWS][8];
    // int grid2[15][COLS];
...
void PrintArrays (const IntArray grid, const int grid2[][COLS]) {
	int row, col; // loop index values
